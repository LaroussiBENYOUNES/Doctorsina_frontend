...
function init(botLogoPath) {
    ...
    template = ` <button class='chat-btn'><img src="chatbot/chatbot.png" class="fx animated fadeInLeft" data-animate="fadeInLeft"></button>
    ...
    <div class='chat-popup fx animated  pulse '>
        ...
        <div class='chat-header'>
            ...
            <button class = "expand-chat-window" ><img src="chatbot/fullscreen.png" class="material-icon"></button>
        </div>
    ...
    chatBtn.addEventListener("click", () => {
        ...
        if (chatPopup.style.display == "none" && mobileDevice) {
            ...
            chatInput.focus();
            chatBtn.innerHTML = `<img src="chatbot/chatbot_close.png" class="fx animated fadeInLeft" data-animate="fadeInLeft">`
        } else if (mobileDevice) {
            chatPopup.style.display = "none"
            chatBtn.innerHTML = `<img src="chatbot/chatbot.png" class="fx animated fadeInLeft" data-animate="fadeInLeft" data-animation-delay="50">`
        } else {
            mobileView()
        }
    })
    ...
    expandWindow.addEventListener("click", (e) => {
        ...
        if (expandWindow.innerHTML == '<img src="chatbot/fullscreen.png" class="material-icon">') {
            expandWindow.innerHTML = `<img src = "chatbot/fullscreen_close.png" class = 'material-icon'>`
            ...
            expandWindow.innerHTML = `<img src = "chatbot/fullscreen.png" class = "material-icon" >`
