...
<div class="row">
    ...
    <h3 style="margin-left:10px">New History Status</h3>
        <br>
        @if ($errors->any())
...
{!! Form::open(array('route' => config('quickadmin.route').'.historystatus.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
