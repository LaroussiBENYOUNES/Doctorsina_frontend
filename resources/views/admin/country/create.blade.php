...
<div class="col-sm-6 col-sm-offset-2">
        <h3 style="margin-left:10px">New Country</h3><br>
...
{!! Form::open(array('route' => config('quickadmin.route').'.country.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
<div class="form-group">
    ...
    <div class="col-sm-6">
        {!! Form::select('zone_id', $zone, old('zone_id'), array('class'=>'form-control')) !!}
