...
<div class="row">
    <div class="col-sm-6 col-sm-offset-2">
        <h3 style="margin-left:10px">New History Attitude</h3>
        <br>
        @if ($errors->any())
...
{!! Form::open(array('route' => config('quickadmin.route').'.historyattitude.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    @if(auth()->user()->role_id==10)
     ...
     @else
     {!! Form::text('user_id', auth()->user()->name, array('class'=>'form-control','style' => 'background-color: #FFFFFF; color: #708090;margin-left:2px;' , 'disabled')) !!}
     @endif
    </div>
</div><div class="form-group">
    {!! Form::label('attitude_id', 'Attitude*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-6">
        {!! Form::select('attitude_id', $attitude, old('attitude_id'), array('class'=>'form-control')) !!}
