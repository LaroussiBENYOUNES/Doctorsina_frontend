...
<div class="col-sm-6 col-sm-offset-2">
        <h3 style="margin-left:10px">Edit Question</h3><br>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        {!! Form::text('alias', old('alias',$question->alias), array('class'=>'form-control')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        {!! Form::textarea('description', old('description',$question->description), array('class'=>'form-control', 'rows' => '5')) !!}
...
<div class="form-group">
    ...
    {!! Form::hidden('activated','') !!}
        {!! Form::checkbox('activated', 1, $question->activated == 1, array('class'=>'marg5','data-toggle'=>'toggle','data-size'=>'mini','data-onstyle'=>'success','data-offstyle'=>'danger')) !!}
    </div>
</div>
<br>
...
<div class="form-group">
    <div class="col-sm-10 col-sm-offset-2">
      ...
      {!! link_to_route(config('quickadmin.route').'.question.index', Cancel, null, array('class' => 'btn btn-default')) !!}
    </div>
</div>
