...
<div class="row">
    ...
    <h3 style="margin-left:10px">New History Allergy</h3>
        <br>
        @if ($errors->any())
...
{!! Form::open(array('route' => config('quickadmin.route').'.historyallergy.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        {!! Form::select('allergy_id', $allergy, old('allergy_id'), array('class'=>'form-control')) !!}
