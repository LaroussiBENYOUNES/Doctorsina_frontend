...
<div class="col-sm-6 col-sm-offset-2">
        <h3 style="margin-left:10px">New</h3><br>
...
{!! Form::open(array('route' => config('quickadmin.route').'.medicastructureoffer.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}

<div class="form-group">
    {!! Form::label('medicalstructure_id', 'Medical Structure*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-6">
        {!! Form::select('medicalstructure_id', $medicalstructure, old('medicalstructure_id'), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('offertype_id', 'Offer*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-6">
        {!! Form::select('offertype_id', $offertype, old('offertype_id'), array('class'=>'form-control')) !!}
