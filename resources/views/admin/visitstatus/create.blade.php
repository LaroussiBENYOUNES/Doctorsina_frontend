...
<div class="col-sm-6 col-sm-offset-2">
        <h3 style="margin-left:10px">New Visit Status</h3><br>
        @if ($errors->any())
...
{!! Form::open(array('route' => config('quickadmin.route').'.visitstatus.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
