...
<div class="col-sm-6 col-sm-offset-2">
        <h3 style="margin-left:10px">New Site</h3><br>
...
{!! Form::open(array('route' => config('quickadmin.route').'.site.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    {!! Form::label('country_id', 'Location*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-6">
