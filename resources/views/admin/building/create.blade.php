...
<div class="col-sm-6 col-sm-offset-2">
        <h3 style="margin-left:10px">New Building</h3><br>
...
{!! Form::open(array('route' => config('quickadmin.route').'.building.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
