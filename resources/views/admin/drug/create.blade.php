...
<div class="col-sm-6 col-sm-offset-2">
        <h3 style="margin-left:10px">New Drug</h3><br>
...
{!! Form::open(array('route' => config('quickadmin.route').'.drug.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}

<div class="form-group">
    {!! Form::label('drugfamilly_id', 'Drug Familly*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-6">
        {!! Form::select('drugfamilly_id', $drugfamilly, old('drugfamilly_id'), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('drugmaker_id', 'Drug Maker*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-6">
        {!! Form::select('drugmaker_id', $drugmaker, old('drugmaker_id'), array('class'=>'form-control')) !!}
