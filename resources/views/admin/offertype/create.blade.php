...
<div class="col-sm-6 col-sm-offset-2">
        <h3  style="margin-left:10px">New Offer Type</h3><br>
...
{!! Form::open(array('route' => config('quickadmin.route').'.offertype.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
